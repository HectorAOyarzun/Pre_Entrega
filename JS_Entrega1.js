...
if (!nombre) {
    alert(`Gracias por tu preferencia. Si aún deseas enviar una solicitud de cotización, envia un mail al siguiente correo: mao@gmail.com`);
    
  } else{
    
  alert("Hola " + nombre + ",  Para medir  el nivel de cumplimiento de tu empresa en matería preventiva, responde la siguiente encuesta.");
  ...
  if (!confirmacion) {
    alert(`${nombre} Gracias por tu preferencia. Si aún deseas enviar una solicitud de cotización, envia un mail al siguiente correo: mao@gmail.com`);
    
  } else {
    
    let preguntas = [
      "Tu empresa cuenta con reglamento Interno de Orden Higiene y Seguridad",
      "Los trabajadores fueron informados sobre los riegos inherentes a los que estaran expuestos, al realizar las funciones para las cuales fueron contratados",
      ...
      "Tu empresa cuenta con una politica en prevencion de riesgos",
